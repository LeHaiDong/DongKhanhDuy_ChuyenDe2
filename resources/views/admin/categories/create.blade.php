...
<div class="admin-card">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-plus" style="margin-right: 8px; color: #28a745;"></i>
            Thêm danh mục mới
        </h3>
    ...
    <div class="card-body">
        @if($errors->any())
            <div class="form-error-summary">
                <strong>Chưa lưu được danh mục.</strong>
                <ul>
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-hint">URL thân thiện cho danh mục. Để trống để tự động tạo từ tên danh mục.</div>
                        @error('slug')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-hint">Số nhỏ hơn sẽ hiển thị trước. Mặc định là 0.</div>
                        @error('sort_order')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="character-count">
                            <span id="metaTitleCount">0</span>/255 ký tự
                        </div>
                        @error('meta_title')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="meta_description" 
                                  ...
                                  rows="3"
                                  maxlength="500"
                                  class="form-input @error('meta_description') error @enderror">{{ old('meta_description') }}</textarea>
                        <div class="character-count">
                            <span id="metaDescCount">0</span>/500 ký tự
                        </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" name="save_and_continue" value="1" class="nike-btn nike-btn-success">
                    <i class="fas fa-save"></i>
                    Lưu và tiếp tục thêm
                </button>
                <a href="{{ route('admin.categories.index') }}" class="nike-btn nike-btn-outline">
